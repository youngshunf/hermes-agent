...
class TestCapabilitiesEndpoint:
    ...
    async def test_capabilities_advertises_plugin_safe_contract(self, adapter):
        ...
        async with TestClient(TestServer(app)) as cli:
            ...
            assert data["features"]["tool_execution_disabled_v1"] is True
            assert data["features"]["dispatch_idempotency_v1"] is True
            assert data["features"]["run_terminal_replay_v1"] is True
